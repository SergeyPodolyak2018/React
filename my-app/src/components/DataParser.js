...
const DataParser = (props) => {
  ...
  return(
	  	...
	  	<div style = {{"width": "100%", "height": "100%", "display": "block", "float": "left", "background":"green"}}>
	  		<div style = {{"width": "70%", "height": "20%", "float": "left","borderBottom": "solid beige","marginLeft": "15%","fontSize": "140%"}}>{day}</div>
